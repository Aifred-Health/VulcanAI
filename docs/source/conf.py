...
project = 'Vulcan'
copyright = '2019, Robert Fratila, Priyatharsan Rajasekar, Caitrin Armstrong, Joseph Mehltretter'
author = 'Robert Fratila, Priyatharsan Rajasekar, Caitrin Armstrong, Joseph Mehltretter'
...
latex_documents = [
    (master_doc, 'Vulcan.tex', 'Vulcan Documentation',
     'Robert Fratila, Priyatharsan Rajasekar, Caitrin Armstrong, Joseph Mehltretter', 'manual'),
]
